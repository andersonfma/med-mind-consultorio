      ...
      <header className="sticky top-0 z-20 bg-surface/85 backdrop-blur-md border-b border-border px-4 py-3 sm:px-6 sm:py-4">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <Link href="/dashboard" className="group flex items-center gap-2.5 sm:gap-3.5">
            <MedMindMark className="h-12 w-12 sm:h-14 sm:w-14 rounded-xl shadow-[var(--shadow-glow-primary)] transition-transform group-hover:scale-105" />
            <span className="font-display text-2xl sm:text-3xl font-bold tracking-tight text-ink leading-none">
