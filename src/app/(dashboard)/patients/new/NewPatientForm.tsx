...
export function NewPatientForm() {
  ...
  return (
    <div className="p-6 max-w-md mx-auto">
      <h1 className="font-display text-xl font-bold text-ink mb-6">Novo Paciente</h1>
      <form onSubmit={(e) => { e.preventDefault(); handleSubmit() }} className="space-y-4">
        <div>
          <label htmlFor="specialty" className="block text-sm font-medium text-muted mb-1">
            Especialidade
          </label>
          <select
            id="specialty"
        ...
        <div>
          <fieldset>
            <legend className="block text-sm font-medium text-muted mb-1">
              Dificuldade
            </legend>
