    ...
    <div className="flex flex-col h-full">
      ...
      <div className="border-t border-border p-4 flex gap-2">
        ...
        <button
          ...
          className="rounded-md bg-primary px-4 py-2 text-sm font-semibold text-primary-ink shadow-[var(--shadow-glow-primary)] transition-colors hover:bg-primary-hover disabled:opacity-50 disabled:cursor-not-allowed"
        >
          Enviar
        </button>
      </div>
